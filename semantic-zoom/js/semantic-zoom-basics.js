...
WinJS.Namespace.define("CustomControls", {
    Timeline: WinJS.Class.define(function(element, options) {
        ...
        for (var i = this._start; i <= this._end; i += this._interval) {
            ...
            caption.textContent = i.toString();
            ...
            container.addEventListener("click", function(ev) {
                if (that._isZoomedOut) {
                    that._clickedContainer = ev.target;
                    that._triggerZoom();
                }
            }, false);
        ...
        _getCurrentItem: function() {
            ...
            var focusedElement = this._clickedContainer || document.activeElement;
            ...
            var /*@override*/item = parseInt(focusedElement.children[0].textContent, 10);
